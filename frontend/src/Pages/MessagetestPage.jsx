                ...
                <div className="h-full w-full flex flex-col relative">
                    ...
                    <div className="flex-1 relative overflow-hidden">
                        ...
                        <div className={`absolute left-0 top-0 bottom-0 z-20 transition-transform duration-500 flex items-center select-none ${isLeftBarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                            <div className="w-44 lg:w-75 h-[95%] bg-black/20 backdrop-blur-sm border-r border-white/10 rounded-r-3xl p-2"><p className="text-[10px] text-gray-500 uppercase font-bold">Mission Params</p></div>
